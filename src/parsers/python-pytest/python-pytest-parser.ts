...
import {JunitReport, SingleSuiteReport, TestCase, TestSuite} from './python-pytest-types'
import {parseStackTraceElement} from './python-stack-trace-element-parser'
...
export class PythonJunitParser implements TestParser {
